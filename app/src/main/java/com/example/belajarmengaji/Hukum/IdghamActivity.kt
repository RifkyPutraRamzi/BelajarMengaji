...
import kotlinx.android.synthetic.main.activity_idgham.*
...
class IdghamActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_bighunnah.setOnClickListener {
            var intent = Intent(this, BighunnahActivity::class.java)
            startActivity(intent)
            finish()
        }

        btn_bilaghunnah.setOnClickListener {
            var intent = Intent(this, BilaghunnahActivity::class.java)
            startActivity(intent)
            finish()
        }
